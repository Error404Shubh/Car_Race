...
cars_img=["images/car0.png", "images/car1.png", "images/car2.png", "images/car3.png", "images/car4.png"]
track=Entity(model='cube', color=color.white, scale=(10, .5, 60), position=(0,0), texture="images/track.png")
